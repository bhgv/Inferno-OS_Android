...
TkCmdtab tklistcmd[] =
{
	"activate",		tklistbactivate,	TK_CMD_IN,
	"cget",			tklistbcget,		TK_CMD_NONE,
	"configure",		tklistbconf,	TK_CMD_NONE,
	"curselection",		tklistbcursel,	TK_CMD_OUT,
	"delete",		tklistbdelete,		TK_CMD_IN,
	"get",			tklistbget,			TK_CMD_INOUT,
	"index",		tklistbindex,		TK_CMD_INOUT,
	"insert",		tklistbinsert,		TK_CMD_IN,
	"nearest",		tklistbnearest,		TK_CMD_INOUT,
	"selection",	tklistbselection,	TK_CMD_IN,
	"see",			tklistbsee,			TK_CMD_IN,
	"size",			tklistbsize,		TK_CMD_OUT,
	"xview",		tklistbxview,		TK_CMD_INOUT,
	"yview",		tklistbyview,		TK_CMD_INOUT,
	"tkListbButton1P",	tklistbbutton1p,	TK_CMD_IN,
	"tkListbButton1R",	tklistbbutton1r,	TK_CMD_IN,
	"tkListbButton1MP",	tklistbbutton1m,	TK_CMD_IN,
	"tkListbKey",	tklistbkey,			TK_CMD_IN,
	nil
};
