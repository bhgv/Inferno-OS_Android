...
TkCmdtab tkentrycmd[] =
{
	"cget",			tkentrycget,		TK_CMD_NONE,
	"configure",		tkentryconf,	TK_CMD_NONE,
	"delete",		tkentrydelete,		TK_CMD_IN,
	"get",			tkentryget,			TK_CMD_OUT,
	"icursor",		tkentryicursor,		TK_CMD_IN,
	"index",		tkentryindex,		TK_CMD_OUT,
	"insert",		tkentryinsert,		TK_CMD_IN,
	"selection",		tkentryselect,	TK_CMD_IN,
	"xview",		tkentryxview,		TK_CMD_IN,
	"tkEntryBS",		tkentrybs,		TK_CMD_IN,
	"tkEntryBW",		tkentrybw,		TK_CMD_IN,
	"tkEntryB1P",		tkentryb1p,		TK_CMD_IN,
	"tkEntryB1M",		tkentryb1m,		TK_CMD_IN,
	"tkEntryB1R",		tkentryb1r,		TK_CMD_IN,
	"tkEntryB2P",		tkentryb2p,		TK_CMD_IN,
	"tkEntryFocus",		tkentryfocus,	TK_CMD_IN,
	"bbox",			tkentrybboxcmd,		TK_CMD_OUT,
	"see",		tkentryseecmd,			TK_CMD_IN,
	nil
};
