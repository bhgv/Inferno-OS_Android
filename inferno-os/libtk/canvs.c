...
TkCmdtab tkcanvcmd[] =
{
	"addtag",		tkcvsaddtag,	TK_CMD_IN,
	"bbox",			tkcvsbbox,		TK_CMD_OUT,
	"bind",			tkcvsbind,		TK_CMD_IN,
	"cget",			tkcvscget,		TK_CMD_NONE,
	"configure",		tkcvsconf,	TK_CMD_NONE,
	"create",		tkcvscreate,	TK_CMD_IN,
	"canvasx",		tkcvscanvx,		TK_CMD_INOUT,
	"canvasy",		tkcvscanvy,		TK_CMD_INOUT,
	"coords",		tkcvscoords,	TK_CMD_INOUT,
	"dchars",		tkcvsdchars,	TK_CMD_IN,
	"delete",		tkcvsdelete,	TK_CMD_IN,
	"dtag",			tkcvsdtag,		TK_CMD_IN,
	"find",			tkcvsfind,		TK_CMD_INOUT,
	"focus",		tkcvsfocus,		TK_CMD_INOUT,
	"gettags",		tkcvsgettags,	TK_CMD_INOUT,
	"grab",		tkcvsgrab,			TK_CMD_INOUT,
	"icursor",		tkcvsicursor,		TK_CMD_IN,
	"insert",		tkcvsinsert,		TK_CMD_IN,
	"index",		tkcvsindex,			TK_CMD_IN,
	"itemcget",		tkcvsitemcget,		TK_CMD_NONE,
	"itemconfigure",	tkcvsitemconf,	TK_CMD_NONE,
	"lower",		tkcvslower,			TK_CMD_IN,
	"move",			tkcvsmove,			TK_CMD_IN,
	"raise",		tkcvsraise,			TK_CMD_IN,
	"screenx",		tkcvsscreenx,		TK_CMD_INOUT,
	"screeny",		tkcvsscreeny,		TK_CMD_INOUT,
	"see",		tkcvssee,				TK_CMD_IN,
	"select",		tkcvsselect,		TK_CMD_IN,
	"scale",		tkcvsscale,			TK_CMD_IN,
	"type",			tkcvstype,			TK_CMD_OUT,
	"yview",		tkcvsyview,			TK_CMD_IN,
	"xview",		tkcvsxview,			TK_CMD_IN,
	nil
};
