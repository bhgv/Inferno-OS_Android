...
TkCmdtab tktextcmd[] =
{
	"bbox",			tktextbbox,				TK_CMD_INOUT,
	"cget",			tktextcget,				TK_CMD_NONE,
	"compare",		tktextcompare,			TK_CMD_INOUT,
	"configure",	tktextconfigure,		TK_CMD_NONE,
	"debug",		tktextdebug,			TK_CMD_IN,
	"delete",		tktextdelete,			TK_CMD_IN,
	"dlineinfo",	tktextdlineinfo,		TK_CMD_INOUT,
	"dump",			tktextdump,				TK_CMD_INOUT,
	"get",			tktextget,				TK_CMD_INOUT,
	"index",		tktextindex,			TK_CMD_INOUT,
	"insert",		tktextinsert,			TK_CMD_IN,
	"mark",			tktextmark,				TK_CMD_IN,
	"scan",			tktextscan,				TK_CMD_IN,
	"search",		tktextsearch,			TK_CMD_INOUT,
	"see",			tktextsee,				TK_CMD_IN,
	"selection",	tktextselection,		TK_CMD_IN,
	"tag",			tktexttag,				TK_CMD_IN,
	"window",		tktextwindow,			TK_CMD_IN,
	"xview",		tktextxview,			TK_CMD_IN,
	"yview",		tktextyview,			TK_CMD_IN,
	"tkTextButton1",	tktextbutton1,		TK_CMD_IN,
	"tkTextButton1R",	tktextbutton1r,		TK_CMD_IN,
	"tkTextDelIns",		tktextdelins,		TK_CMD_IN,
	"tkTextInsert",		tktextinserti,			TK_CMD_IN,
	"tkTextSelectTo",	tktextselectto,			TK_CMD_IN,
	"tkTextSetCursor",	tktextsetcursor,			TK_CMD_IN,
	"tkTextScrollPages",	tktextscrollpages,			TK_CMD_IN,
	"tkTextCursor",		tktextcursor,			TK_CMD_IN,
	nil
};
